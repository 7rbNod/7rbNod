...
import os
THOMAS=render('{THOMAS TIKTOK}',colors=['green','white'],align='center')
print(f'''  ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓   
                      {HRB}
    ~ Programmer : @PP111P1 | Channel: @ZGf_f
   ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛    ''')
...
def check_tiktok_account(email):
    url = "https://api.tiktok.com/account/verify"  # فرضًا لو كان فيه API
    params = {"email": email}

    response = requests.get(url, params=params)

    if response.status_code == 200:
        return "البريد الإلكتروني مرتبط بحساب تيك توك"
    else:
        return "البريد الإلكتروني غير مرتبط بحساب تيك توك"
    ff = (f'''
𓊆𝐴𝐶𝐶𝑂𝑈𝑁𝑇 𝑇𝐼𝐾𝑇𝑂𝐾𓊇       𒋨────━𓆩𝐓𝐇𝐎𝐌𝐀𝐒𓆪‏━────𒋨
🦍 𝐇𝐢𝐭: [  {hit}   ] 
🦍 name [ {name} ] 
🦍 user :   [ {user} ]
...
def vip_priv(email):
    ...
    "c3058b76be0aba378b47697c535eb916"
        ...
        if "Email is linked to another account. Unlink or try another email" in response.text:
            ...
            os.system('cls' if os.name == 'nt' else 'clear')
            bt += 1
            print(f"\r  o   {F} Hit  {HH}: {M}{ge} ~ {Z} Kötü {HH}: {M}{bt} ~ {X} Orta Mail {HH}: {M}{be} {G} {F} @t5omas\r")
    except ValueError:
        print(f" e e e e  ")
